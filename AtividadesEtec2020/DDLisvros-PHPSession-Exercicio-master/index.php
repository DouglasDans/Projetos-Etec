    ...
    <div class="nav-container justify-content-end ">
      <nav class="navbar navbar-expand-md navbar-white fixed-top p-0 justify-content-end nav-color p-2">
        <div class="container">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <form method="post" class="text-white"  action="valida-login.php">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-caption d-none d-md-block">
              ...
              <a name="button" class="btn btn-primary" href="cont.php" role="button">Veja mais dos nossos produtos</a>
            </div>
          </div>
          <div class="carousel-item">
        ...
        <div class="row justify-content-around align-items-center">
          <div class="col-12 col-md-6 col-lg-5 text-center text-md-left section-intro">
            ...
            <span class="lead">
              ...
              <br><br>
              <a name="button" class="btn btn-primary" href="cont.php" role="button">Visitar Site
                Legado</a>
            </span>
          </div>
          <div class="col-12 col-md-5 order-md-1">
