...
public class Pergunta9 extends JFrame {
	...
	public Pergunta9() {
		...
		JLabel lblNewLabel_1 = new JLabel("Quais subst\u00E2ncias s\u00E3o fontes de energia para o nosso corpo ?");
		...
		btnPrximaPegunta.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (rbGrupo.isSelected(null)) {
					...
					Pergunta10 tela = new Pergunta10();
					tela.setVisible(true);
					Pergunta9.this.dispose();
				}
			}
